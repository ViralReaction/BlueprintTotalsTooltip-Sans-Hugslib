...
namespace BlueprintTotalsTooltip
{
    ...
    {
        public static void DrawIntOptionWithButtons(Rect rect, ref int value, string label, int minValue, int maxValue)
        {
            ...
            {
                value = Math.Max(value - 10, minValue); // Decrease value, but don't go below minValue
            }
            ...
            {
                value = Math.Min(value + 10, maxValue); // Increase value, but don't exceed maxValue
            }
